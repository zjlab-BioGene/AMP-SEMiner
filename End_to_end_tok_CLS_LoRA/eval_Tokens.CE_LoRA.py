...
from train_Tokens_LoRA import MyDataset, MyTokensClassification
...
def get_parameters():
    ...
    parser.add_argument('--model_name', type=str, default='/home/lwh/00.data/AMP/train/esm_token_focalloss/finetune/esm2_t33_650M_UR50D-rank-8-ft-for-TokenCLS-labelSmth-0.0/epoch11-checkpoint-2045802' , help='YOUR_MODEL_PATH.')
...
def main():
    ...
    ## val dataset
        ...
        #                                 tokenizer, args.max_len, args.batch_size, data_type='val')
